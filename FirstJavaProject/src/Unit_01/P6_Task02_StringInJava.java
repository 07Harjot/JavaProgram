...
class StringInJava {
	 ...
	 *In Java,the JVM maintains a string pool to store all of its strings inside th memory.
	 *The string pool helps in reusing the strings.
	    -If the string already exists,the new string is not created.
	    Instead, hte new reference,example points to the already existed string (Java).
